...
//--------------------|    MAIN RENDER     |--------------------//
//--------------------|____________________|--------------------//
export default function ProjectCard({ title, description, image, demoLink, designLink, githubLink, techStack = [] }) {
  const ActionButton = ({ href, text, icon, variant = 'primary' }) => {
    ...
    const variantClasses = {
      primary: "bg-neutral-200 text-neutral-900 hover:bg-white focus:ring-neutral-400 shadow-white/10",
      ...
      <div className='flex flex-col flex-grow p-6'>
        ...
        <div className="mt-6 flex justify-start gap-3">
          {demoLink || githubLink || designLink ? (
            ...
            <div className="text-left text-orange-400 text-xs font-semibold tracking-wider uppercase">
              * Private Project
            </div>
          )}
        </div>
